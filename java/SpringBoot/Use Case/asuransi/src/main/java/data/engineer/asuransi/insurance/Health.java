...
@Slf4j
@Component("health")
public class Health implements ClaimHandler {
    ...
    public void addCustomer(Customer customer) {
        ...
        log.info("customer dengan nama {} berhasil ditambahkan", customer.getName());
    }

    @Override
    public void processClaim(InsuranceClaim insuranceClaim, String noKTP) {
        if (!insuranceClaim.getPolicyId().isEmpty() && Objects.equals(insuranceClaim.getType(), "health")) {
