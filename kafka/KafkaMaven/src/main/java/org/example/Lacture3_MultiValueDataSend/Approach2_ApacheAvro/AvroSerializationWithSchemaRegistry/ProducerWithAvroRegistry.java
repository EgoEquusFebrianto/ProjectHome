package org.example.Lacture3_MultiValueDataSend.Approach2_ApacheAvro.AvroSerializationWithSchemaRegistry;
...
public class ProducerWithAvroRegistry {
    private static final Logger log = LoggerFactory.getLogger(ProducerWithAvroRegistry.class);
